        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    Title2 = table.Column<string>(maxLength: 256, nullable: true),
                    Synopsis = table.Column<string>(maxLength: 500, nullable: true),
                    Pg = table.Column<string>(maxLength: 50, nullable: true),
                    Director = table.Column<string>(maxLength: 100, nullable: true),
                    Published = table.Column<string>(maxLength: 100, nullable: true),
                    RunningTime = table.Column<string>(maxLength: 30, nullable: true),
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        ...
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_RolePermissions_Users_UsersId",
                        column: x => x.UsersId,
                        principalTable: "Users",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Comments_Movies_ObjectId",
                        column: x => x.ObjectId,
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Recommended_Movies_MovieId",
                        column: x => x.MovieId,
                        principalTable: "Movies",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
            ...
            migrationBuilder.CreateIndex(
                name: "IX_RolePermissions_UsersId",
                table: "RolePermissions",
                column: "UsersId");
